# 1 -Things to Remember translated
...
imbalance data sets and improve model performance.

Neural networks benefit significantly from data normalization and preprocessing, especially

for categorical features.

Tools like Kirus and Numpi are widely used for this purpose.
...
Model parallelism is ideal for situations when the neural network is too big to fit in a
...
Those large data sets efficiently and has built-in feature importance.
